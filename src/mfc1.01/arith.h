 ...
 * the speed of the arithmetic operations (multiplication, division, shift,
 * etc).
...
typedef unsigned code_value;	// B_BITS of precision
typedef unsigned freq_value;	// F_BITS+1 of precision
typedef unsigned div_value;		// B_BITS-F_BITS of precision
...
// function prototypes
void arithmetic_encode(freq_value l, freq_value h, freq_value t, Stream *s);
freq_value arithmetic_decode_target(freq_value t);
void arithmetic_decode(freq_value l, freq_value h, freq_value t, Stream *s);
void binary_arithmetic_encode(freq_value c0, freq_value c1, int bit, Stream *s);
int binary_arithmetic_decode(freq_value c0, freq_value c1, Stream *s);
void start_encode(void);
void finish_encode(Stream *s);
void start_decode(Stream *s);
